...
('85022602', 'Rua Douglas Rodrigo Sanquetta', 'Boqueirão', 'Guarapuava', 'Paraná', 947, 'apt 202');
...
INSERT INTO endereco(CEP, rua, bairro, cidade, estado, numero, complemento) VALUES 
('75095220', 'Rua Limiro de Oliveira', 'Setor Tropical', 'Anápolis', 'Goiás', 692, 'apt 208');
INSERT INTO corretor(cpf, nome, data_de_nascimento, sexo, fk_endereco, fk_login, horario_trabalho_inicio, horario_trabalho_final) VALUES
...
INSERT INTO endereco(CEP, rua, bairro, cidade, estado, numero, complemento) VALUES 
('76824260', 'Rua Francisco Barros', 'Igrapé', 'Porto Velho', 'Rondônia', 341, 'casa verde');
INSERT INTO cliente(cpf, nome, data_de_nascimento, sexo, fk_endereco, fk_login) VALUES
...
INSERT INTO endereco(CEP, rua, bairro, cidade, estado, numero, complemento) VALUES 
('66913070', 'Travessa Eurico Romariz', 'Chapéu Virado (Mosqueiro)', 'Belém', 'Pará', 757, 'apt 109');
INSERT INTO cliente(cpf, nome, data_de_nascimento, sexo, fk_endereco, fk_login) VALUES
...
INSERT INTO endereco(CEP, rua, bairro, cidade, estado, numero, complemento) VALUES 
('05653100', 'Rua Gina de Martino', 'Jardim Leonor', 'São Paulo', 'São Paulo', 943, 'apt 906');
INSERT INTO proprietario(cpf, nome, data_de_nascimento, sexo, fk_endereco, fk_login) VALUES
...
INSERT INTO endereco(CEP, rua, bairro, cidade, estado, numero, complemento) VALUES 
('74365320', 'Rua B 4', 'Setor Novo Horizonte', 'Goiânia', 'Goiás', 798, 'apt 146');
...
INSERT INTO endereco(CEP, rua, bairro, cidade, estado, numero, complemento) VALUES 
('04928160', 'Rua Ezequiel Alves Ramos', 'Copacabana', 'São Paulo', 'São Paulo', 871, 'apt 708');
...
INSERT INTO endereco(CEP, rua, bairro, cidade, estado, numero, complemento) VALUES 
('02883154', 'Rua Erasmo Souza', 'Vila Nova Parada', 'São Paulo', 'São Paulo', 169, 'apt 508');
